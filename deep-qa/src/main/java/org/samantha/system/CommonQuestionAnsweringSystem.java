...
package org.samantha.system;

import java.util.ArrayList;
import java.util.List;

import org.samantha.datasource.DataSource;
import org.samantha.datasource.FileDataSource;
import org.samantha.files.FilesConfig;
import org.samantha.questiontypeanalysis.patternbased.DefaultPatternMatchResultSelector;
import org.samantha.questiontypeanalysis.patternbased.PatternBasedMultiLevelQuestionClassifier;
import org.samantha.questiontypeanalysis.patternbased.PatternMatchResultSelector;
import org.samantha.questiontypeanalysis.patternbased.PatternMatchStrategy;
import org.samantha.questiontypeanalysis.QuestionClassifier;
import org.samantha.questiontypeanalysis.patternbased.QuestionPattern;
import org.samantha.score.answer.CandidateAnswerScore;
import org.samantha.score.answer.CombinationCandidateAnswerScore;
import org.samantha.score.answer.HotCandidateAnswerScore;
import org.samantha.score.answer.MoreTextualAlignmentCandidateAnswerScore;
import org.samantha.score.answer.RewindTextualAlignmentCandidateAnswerScore;
import org.samantha.score.answer.TermDistanceCandidateAnswerScore;
import org.samantha.score.answer.TermDistanceMiniCandidateAnswerScore;
import org.samantha.score.answer.TermFrequencyCandidateAnswerScore;
import org.samantha.score.answer.TextualAlignmentCandidateAnswerScore;
import org.samantha.score.evidence.BigramEvidenceScore;
import org.samantha.score.evidence.CombinationEvidenceScore;
import org.samantha.score.evidence.EvidenceScore;
import org.samantha.score.evidence.SkipBigramEvidenceScore;
import org.samantha.score.evidence.TermMatchEvidenceScore;
import org.samantha.select.CandidateAnswerSelect;
import org.samantha.select.CommonCandidateAnswerSelect;
...
public class CommonQuestionAnsweringSystem extends QuestionAnsweringSystemImpl {
    ...
    public CommonQuestionAnsweringSystem() {
        ...
        LOG.info("智能答疑数据源：" + FileDataSource.class);
