...
package org.samantha.questiontypeanalysis.patternbased;
...
public class DefaultPatternMatchResultSelector implements PatternMatchResultSelector {
    ...
    public Question select(Question question, PatternMatchResult patternMatchResult) {
        ...
        LOG.info("匹配未成功，不能识别问题类型，不能识别的问题类型统一指定为："+QuestionType.MISC);
        question.setQuestionType(QuestionType.MISC);
        return question;
    }
