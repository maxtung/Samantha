...
<html>
    ...
    <body>
        <h1><font color="blue">智能答疑系统演示
        <!--<a href="https://github.com/ysc/QuestionAnsweringSystem" target="_blank">项目主页</a>-->
        </font></h1>
        <h2>
        <!--<a href="index.jsp?q=<%=questionStr%>">忽略细节</a>-->
        </h2>
                <%
                    if (questionStr == null || questionStr.trim().length() <= 3) {
                %>      
        ...
        %>  	
        <br/>
        <h2><a href="<%=request.getContextPath()%>/index.jsp">返回主页</a></h2>
